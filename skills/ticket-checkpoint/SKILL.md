...
The vocabulary, the note rules and the phase-derivation table are in `ticket-common/STATUS.md`. Then recompute the phase's Progress table row from its steps.
